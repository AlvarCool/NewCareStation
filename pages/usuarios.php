          ...
          <div class="card mb-5">
            <div class="card-header pb-0">
              ...
              <div style="text-align: right; margin-right: 70px;">
                <a href="alta_usuario.php"><img src="../assets/img/add_user.png" style="height: 30px; padding-right: 50px;"></a>
              </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                ...
                $usuarios = mysqli_query($con, "SELECT * FROM esp_data.usuarios;");
                if ($usuarios) { 
                ?>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr class="align-middle text-center text-sm">
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">PRIVILEGIO</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">ACCIONES</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php  while ($reg_us=mysqli_fetch_array($usuarios)) {    
                      $privilegio = "0";
                    ?>
                    <tr>
                      <td>
                        <div class="align-middle text-center text-sm">
                          <p class="text-xs font-weight-bold mb-0"><?php echo $reg_us['id'];?></p>
                        </div>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <div class="align-middle text-center text-sm">
                          <p class="text-xs font-weight-bold mb-0"><?php echo $reg_us['usuario'];?></p>
                        </div>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <div class="align-middle text-center text-sm">
                          <?php
                            if($reg_us['privilegio'] == 0){
                              $privilegio = "Usuario";
                            }else{
                              $privilegio = "Administrador";
                            }
                          ?>
                          <p class="text-xs font-weight-bold mb-0"><?php echo $privilegio;?></p>
                        </div>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <div class="align-middle text-center text-sm">
                            <a href="cambio_usuario.php?id=<?php echo $reg_us['id'] ?>"><img src="../assets/img/icons/editar.png" style="height: 30px;"></a>
                            <a href="eliminar.php?id=<?php echo $reg_us['id'] ?>"><img src="../assets/img/icons/eliminar.png" style="height: 30px; padding-left: 25px"></a>
                        </div>
                      </td>
                    </tr>
                    <?php }?>
