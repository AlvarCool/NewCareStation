...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <main class="main-content position-relative border-radius-lg ">
    ...
    $temperatura = mysqli_query($con, "SELECT * FROM esp_data.temperatura order by id_temp desc limit 250;");
    $humedad = mysqli_query($con, "SELECT * FROM esp_data.humedad order by id_hum desc limit 250;");
    $humedad_rel = mysqli_query($con, "SELECT * FROM esp_data.humedad_rel order by id_humrel desc limit 250;");
    $uv = mysqli_query($con, "SELECT * FROM esp_data.uv order by id_uv desc limit 250;");
    
    if($_GET['sensor'] == "temp"){
        $sensor = "temperatura";
        $label = "Temperatura";
    }elseif($_GET['sensor'] == "hum"){
        $sensor = "humedad";
        $label = "Humedad";
    }elseif($_GET['sensor'] == "humrel"){
        $sensor = "humedad_rel";
        $label = "Humedad relativa";
    }elseif($_GET['sensor'] == "uv"){
        $sensor = "uv";
        $label = "UV";
    }
    ?>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="javascript:;">Informacion</a></li>
            <li class="breadcrumb-item text-sm text-white active" aria-current="page"><?php echo $label ?></li>
          </ol>
        </nav>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr class="align-middle text-center text-sm">
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"><?php echo $label ?></th>
